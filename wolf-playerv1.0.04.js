...
`;
  ...
  takeScreenshot() {
    ...
    try {
      // Método 1: Canvas directo (funciona en la mayoría de casos)
      ...
      try {
        ...
        // Intentar convertir a blob (más compatible con iframes)
        canvas.toBlob((blob) => {
          if (blob) {
            // Método de descarga en iframe
            ...
            // Fallback a dataURL si blob falla
